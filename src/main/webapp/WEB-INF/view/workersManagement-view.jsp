...
<body>
	...
	<form:form action="${pageContext.request.contextPath}/clubs/workers"
			...
			<div class="form-group">
				<label for="sel1" style="margin: 10px;">Wybierz klub:</label> <select class="form-control"
					id="sel11" name="selected" style="margin: 10px;">
			...
			<input type="submit" value="Wyświetl pracowników" class="btn btn-outline-dark"
				style="margin: 10px;" />
