...
<div id="container" style="padding-top: 20px">
	<h3 style="width: 50%; margin: 0 auto; padding-top: 20px; margin-bottom: 20px; align-text: center;">Zarządzanie danymi użytkownika</h3>
	
	<form:form action="updateUser" modelAttribute="user" method="POST" style="width: 50%; margin: 0 auto; padding-top: 20px; margin-bottom: 20px;">
		...
		<form:hidden path="registrationDate"/>
			<table>
				<tbody>
					...
					<tr style="width: 50%; margin: 0 auto;">
						<td><label>Data rejestracji:</label></td>
